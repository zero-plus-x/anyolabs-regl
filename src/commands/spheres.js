...
import { generateHueVariants, hsvToRgb } from '../utils'
import { N, TOTAL, OFFSET} from './constants'
...
export const createDrawSpheresCommand = (regl, offsetBuffer) => regl({
  vert: sphereVert,
  frag: sphereFrag,
...
export const createDrawDepthCommand = (regl, offsetBuffer) => regl({
  vert: sphereVert, // Reuse your sphere vertex shader
  ...
  frag: `
    ...
    void main() {
      float linearDepth = length(v_worldPos - cameraPosition) / 100.0; // normalize to [0,1]
